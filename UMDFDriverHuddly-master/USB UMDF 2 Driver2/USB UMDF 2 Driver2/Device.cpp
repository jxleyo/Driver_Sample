...
--*/
{
	...
	WdfDeviceInitSetIoType(DeviceInit, WdfDeviceIoBuffered); //STIG
    ...
    if (NT_SUCCESS(status)) 
	{
        ...
        //
		TraceEvents(TRACE_LEVEL_INFORMATION, TRACE_DRIVER, "%!FUNC! Device created");
        ...
        deviceContext->PrivateDeviceData = 0; //STIG
        ...
        // to us.
        //
        status = WdfDeviceCreateDeviceInterface(device, &GUID_DEVINTERFACE_USBUMDF2Driver2,NULL);

        if (NT_SUCCESS(status)) {
            //
            // Initialize the I/O Package and any Queues
            //
			TraceEvents(TRACE_LEVEL_INFORMATION, TRACE_DRIVER, "%!FUNC! Device interface created");
...
--*/
{
	...
	TraceEvents(TRACE_LEVEL_INFORMATION, TRACE_DEVICE,"WdfUsbTargetDeviceGetNumInterfaces %i \n",(int)usbInterfaces);
